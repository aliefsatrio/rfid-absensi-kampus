...
public class DataKehadiran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        public Monitoring() {
            ...
            try {
                // 1. Ambil gambar asli dari resources
                // Sesuaikan nama file: /resources/Picture1.png
                javax.swing.ImageIcon iconAsli = new javax.swing.ImageIcon(getClass().getResource("/resources/Picture1.png"));

                // 2. Proses Scaling (Mengecilkan)
                // lblLogo adalah nama variabel JLabel Anda
                java.awt.Image img = iconAsli.getImage();
                java.awt.Image imgBaru = img.getScaledInstance(lblLogo.getWidth(), lblLogo.getHeight(), java.awt.Image.SCALE_SMOOTH);

                // 3. Masukkan kembali ke Label
                lblLogo.setIcon(new javax.swing.ImageIcon(imgBaru));
        ...
        pnlContent.add(pnlVisitorCard, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 200, 60));
        ...
        pnlContent.add(cbFilterProdi, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 50, 80, -1));
        ...
        pnlContent.add(cbFilterKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 50, 80, -1));

        btnSimpanFilter.setBackground(new java.awt.Color(51, 204, 0));
        btnSimpanFilter.setText("Simpan");
        pnlContent.add(btnSimpanFilter, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 50, -1, -1));

        lblVisitorLabel.setText("Jumlah Visitor");
        pnlContent.add(lblVisitorLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 116, -1, 10));
        ...
        lblSubtitle.setText("Menejemen Kehadiran CRUD");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DataKehadiran().setVisible(true));
    }
